...
def extract_probate_page1(client: anthropic.Anthropic, png_bytes: bytes) -> dict:
    ...
    prompt = (
        ...
        "IMPORTANT RULES: "
        "(1) If the name contains 'A/K/A' or 'also known as', use ONLY the name BEFORE the A/K/A — ignore everything after it. "
        "E.g. 'Charles D. O Leary Jr. A/K/A Charles O Leary' → first='Charles D.', last='O Leary'. "
        "(2) If the name field says 'Heirs, Devisees, and Legal Representatives of the Estate of [NAME]' "
        "or similar estate language, extract the actual person's name after 'Estate of'. "
        "E.g. 'Heirs, Devisees of the Estate of Susana V. Gomez A/K/A ...' → first='Susana V.', last='Gomez'. "
        "(3) Do NOT include generational suffixes (Jr., Sr., III, etc.) in the first name field.\n"
        ...
        "Apply the same A/K/A and Estate-of rules as above.\n"
